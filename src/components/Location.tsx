  ...
  return (
    ...
    >
      ...
      <div className="relative flex items-center justify-center" style={{ width: 180, height: 180 }}>
        ...
        {/* Pin tengah */}
        <motion.div
          className="relative z-10 w-12 h-12 bg-brand-red rounded-full flex items-center justify-center"
...
export default function Location() {
  ...
  return (
    <section className="max-w-7xl mx-auto px-4 md:px-6 py-12 md:py-16">
      <div className="bg-creamy-darker rounded-[2rem] md:rounded-[3rem] overflow-hidden flex flex-col md:flex-row shadow-xl border border-creamy-darker">

        {/* ── Left panel ── */}
        <div className="w-full md:w-2/5 p-6 md:p-14 flex flex-col justify-center">
          <div className="relative w-14 h-14 md:w-16 md:h-16 mb-6 md:mb-8">
            <div className="w-14 h-14 md:w-16 md:h-16 bg-white rounded-full flex items-center justify-center shadow-sm">
              <Store size={28} className="text-brand-red opacity-20" />
              <Store size={28} className="text-brand-red absolute" />
            </div>
          </div>

          <h2 className="font-display text-3xl md:text-4xl font-bold text-brand-red mb-4 md:mb-6">Cari Gerobak Kami</h2>
          <p className="text-base md:text-lg text-zinc-700 mb-8 md:mb-10 leading-relaxed">
            Gerobak kayu kami parkir di sudut jalan depan teh solo Halimun. Ikuti aroma wangi mentega dan saus takoyaki!
          </p>

          <div className="space-y-6 md:space-y-8 text-zinc-900">
            <div className="flex gap-4 md:gap-5 items-start">
              <div className="p-2 bg-brand-green/10 rounded-lg text-brand-green shrink-0">
                <MapPin size={22} />
              </div>
              <div>
                <h4 className="font-bold text-base md:text-lg">Lokasi Saat Ini</h4>
                <p className="text-zinc-600 mt-1 text-sm md:text-base">Jl. Halimun Raya,<br />(Depan Teh Solo Halimun)</p>
                <a
                  href={GMAPS_LINK}
                  target="_blank"
            ...
            <div className="flex gap-4 md:gap-5 items-start">
              <div className="p-2 bg-brand-yellow/20 rounded-lg shrink-0">
                <Clock size={22} className="text-zinc-900" />
              </div>
              <div>
          ...
          {STREET_VIEW_IMG && (
            <motion.button
              ...
              className="mt-8 md:mt-10 flex items-center gap-3 bg-zinc-900 text-white px-6 py-3.5 rounded-2xl font-bold text-sm shadow-lg hover:bg-zinc-800 transition-colors w-max"
            >
              <Satellite size={18} />
              Lihat Gerobak
            </motion.button>
        ...
        <div className="w-full md:w-3/5 h-[280px] sm:h-[360px] md:h-auto relative overflow-hidden">
          <iframe
        ...
        {stage !== "idle" && (
          ...
          >
            ...
            <button
              ...
              className="absolute top-5 right-5 md:top-6 md:right-6 z-20 w-11 h-11 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center text-white transition-colors"
            >
              <X size={20} />
            </button>
              ...
              {stage === "street" && STREET_VIEW_IMG && (
                ...
                >
                  ...
                  <motion.div
                    ...
                    className="absolute bottom-8 md:bottom-10 left-1/2 -translate-x-1/2 bg-white/95 backdrop-blur-md rounded-2xl px-6 md:px-8 py-4 md:py-5 text-center shadow-2xl w-[calc(100%-2rem)] max-w-[300px]"
                  >
